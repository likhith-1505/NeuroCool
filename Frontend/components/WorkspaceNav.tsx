    ...
    <header className="sticky top-0 z-40 px-3 pt-3 sm:px-5 sm:pt-4 lg:px-8">
      <nav className="mx-auto grid h-14 w-full max-w-[1720px] grid-cols-[auto_1fr_auto] items-center gap-3 rounded-full bg-[linear-gradient(120deg,rgba(255,255,255,0.085),rgba(255,255,255,0.02))] px-3 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.08),0_18px_48px_rgba(0,0,0,0.45)] backdrop-blur-[24px] sm:px-4">
        <div className="flex items-center gap-2">
          <span className="h-2 w-2 rounded-full bg-violet-300 shadow-[0_0_12px_rgba(191,163,255,0.9)]" />
                ...
                <>
                  ...
                  {isActive ? (
                    <motion.span
                      ...
                      className="absolute inset-0 rounded-full bg-violet-300/[0.14]"
                      transition={{ type: "spring", stiffness: 420, damping: 34 }}
                    />
                  ) : null}
                  <motion.span
                    className="pointer-events-none absolute bottom-[2px] left-1/2 h-[2px] w-0 -translate-x-1/2 rounded-full bg-gradient-to-r from-violet-200 to-indigo-200"
        ...
        <div className="flex items-center justify-end gap-1.5">
          <div className="hidden items-center gap-2 rounded-full border border-violet-200/14 bg-violet-300/[0.08] px-3 py-1 md:inline-flex">
            <span className="relative flex h-2 w-2">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-violet-300/60" />
          ...
          <button
            ...
            aria-label="Theme"
            className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/[0.04] text-white/62 transition duration-300 ease-[cubic-bezier(0.2,0.8,0.2,1)] hover:-translate-y-[1px] hover:bg-white/[0.11] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-300/70"
          >
            {theme === "dark" ? "◐" : "◑"}
          </button>
          ...
          <button
            type="button"
            aria-label="Profile"
            className="inline-flex h-8 items-center justify-center rounded-full border border-white/14 bg-[linear-gradient(140deg,rgba(184,157,255,0.35),rgba(111,133,255,0.35))] px-3 text-[0.56rem] uppercase tracking-[0.12em] text-white shadow-[0_8px_20px_rgba(36,16,88,0.45)]"
          >
            Profile
          </button>
        </div>
