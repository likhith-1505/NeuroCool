...
export default function AIPanel({
  ...
  return (
    <motion.aside
      layout
      className={`relative h-full min-h-[40rem] w-full overflow-hidden rounded-[2rem] bg-[linear-gradient(176deg,rgba(18,12,44,0.82),rgba(10,7,24,0.9))] p-5 shadow-[0_24px_70px_rgba(0,0,0,0.56)] backdrop-blur-2xl ${className ?? ""}`}
    >
      ...
      <div className="relative z-10 flex h-full flex-col">
        <div className="mb-4 flex items-center justify-between gap-3">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-violet-300/18 bg-violet-300/[0.08] px-3 py-1.5">
            <span className="relative flex h-2 w-2">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-violet-300/65" />
              <span className="relative inline-flex h-2 w-2 rounded-full bg-violet-300 shadow-[0_0_12px_rgba(196,169,255,0.88)]" />
            </span>
            <span className="text-[0.56rem] uppercase tracking-[0.16em] text-white/66">Live Model</span>
          </div>
        </div>

        <div className="grid grid-cols-[auto_1fr] gap-4 rounded-2xl bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.015))] px-4 py-4">
          <div className="relative flex h-20 w-20 items-center justify-center rounded-full border border-white/12 bg-black/20">
            <div
            ...
            />
            <div className="absolute inset-[8px] rounded-full bg-[#110b28]/95" />
            <div className="relative z-10 text-center">
              <p className="text-[1.2rem] font-semibold leading-none text-white">{confidence}</p>
              <p className="mt-0.5 text-[0.52rem] uppercase tracking-[0.2em] text-white/52">CONF</p>
            </div>
          </div>
        ...
        <div className="mt-auto pt-4">
          <motion.button
            ...
            className="inline-flex w-full items-center justify-center rounded-xl border border-violet-200/24 bg-[linear-gradient(120deg,rgba(137,104,255,0.46),rgba(107,127,255,0.4))] px-4 py-3 text-[0.7rem] font-medium uppercase tracking-[0.16em] text-white shadow-[0_14px_30px_rgba(18,8,44,0.58)] transition duration-300 ease-[cubic-bezier(0.2,0.8,0.2,1)] hover:shadow-[0_18px_38px_rgba(38,20,92,0.66)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-300/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#100922] disabled:cursor-not-allowed disabled:opacity-50"
          >
            <AnimatePresence mode="wait" initial={false}>
              <motion.span
